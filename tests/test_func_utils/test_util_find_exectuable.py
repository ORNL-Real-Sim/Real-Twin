...
"""Test the find_executable_on_win function"""
...
from realtwin.util_lib.find_executable_path import (  # noqa: E402
...
class TestFindExeOnWin:
    ...
    def test_sel_dir_error(self):
        ...
        with pytest.raises(ValueError, match="sel_dir should be a list."):
            find_executable_on_win(exe_name=self.EXE_NAME, sel_dir=123)
