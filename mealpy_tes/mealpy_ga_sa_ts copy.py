...
class BehaviorOpt:
    ...
    def __init__(self, init_solution: list | np.array = None, problem_dict: dict = None, term_dict: dict = None):
...
if __name__ == "__main__":
    ...
    model_sa = SA.OriginalSA(epoch=1000, pop_size=2,
                             temp_init=100, step_size=0.1,)
